...
$tmp_file = $_FILES['fileGbUpload']["tmp_name"];


//Testando se o arquivo foi realmente setado e salvado ele 
//na variável$target_file
if (isset($_POST['fileGbUpload'])) {
    $target_file = $_POST['fileGbUpload'];
} else {
    $target_file = basename($_FILES["fileGbUpload"]["name"]);
}
//Definindo o diretório onde salvar o arquivo
$upload_dir = "referencesGb";
//Pegando o tamanho do arquivo enviado
$size = $_FILES['fileGbUpload']['size'];
//Pegando o tipo do arquivo enviado
$fileType = $_FILES["fileGbUpload"]["type"];
//Salvado na sessão o nome do arquivo
$_SESSION['sendFileNameGb'] = $target_file;
...
if ($status) {
    echo $_SESSION['sendFileNameGb'] ." uploaded successfully";
