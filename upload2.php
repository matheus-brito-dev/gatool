...
$max_filesize = 1024 * 1000000;

// Definindo variavel temporária para guardar o arquivo
$tmp_file = $_FILES['fileFastaUpload']["tmp_name"];


//Testando se o arquivo foi realmente setado e salvado ele 
//na variável$target_file
if (isset($_POST['fileFastaUpload'])) {
    $target_file = $_POST['fileFastaUpload'];
} else {
    $target_file = basename($_FILES["fileFastaUpload"]["name"]);
}
//Definindo o diretório onde salvar o arquivo
$upload_dir = "referencesFasta";
//Pegando o tamanho do arquivo enviado
$size = $_FILES['fileFastaUpload']['size'];
//Pegando o tipo do arquivo enviado
$fileType = $_FILES["fileFastaUpload"]["type"];
//Salvado na sessão o nome do arquivo
$_SESSION['sendFileNameFasta'] = $target_file;
...
if ($status) {
    echo $_SESSION['sendFileNameFasta'] ." uploaded successfully";
