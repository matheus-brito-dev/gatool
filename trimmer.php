...
class Operacao{
	...
	public function trimmer1(){


	}

	public function trimmer2($op0,$op1,$op2){
                    ...
                    switch($op0){
                        ...
                        case 1:
                            try{
                                ...
                                echo exec($cmd_trimmer, $out_trimmer,$exitTrimmer);
                                
                                echo $_SESSION['saidaTrimmer'] = $_SESSION['nameExt'] . self::ARGS_PARAMS3 . $op1 . self::ARGS_PARAMS4 . $op2 . '_trimming.fastq';
...
$op->{$operacao}($n0,$n1,$n2); //passando os atributos por parametro
